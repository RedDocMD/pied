...
// The exception context as is stored on the stack on exception entry
#[repr(C)]
struct ExceptionContext {
    ...
    // Exception link register. The PC at the time the exception happened
    elr_el1: u64,
...
// Default - when we have no real handler
